...
Also,
\begin{mathpar}
\braket{a}{b} = \sum\limits_{i=1}^{n} a_i^* b_i

\braket{b}{a} = \sum\limits_{i=1}^{n} b_i^* a_i \\

\braket{b}{a}^* = \sum\limits_{i=1}^{n} a_i^* b_i = \braket{a}{b}
\end{mathpar}

So,

\begin{mathpar}
\braket{\psi_2}{\psi_1}\braket{\psi_1}{\psi_2} = |\braket{\psi_2}{\psi_1}|^2

\braket{\psi_1}{\psi_2}\braket{\psi_2}{\psi_1} = |\braket{\psi_2}{\psi_1}|^2
\end{mathpar}
